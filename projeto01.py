...
botao_cancelar_edicao = customtkinter.CTkButton(quadro_edicao, text="Cancelar", text_color="black", fg_color="#83A2EB", width=100, corner_radius= 30)
botao_cancelar_edicao.grid(row=5 , column=2, columnspan=1, pady=5, padx=5, sticky="w")
 
botao_enviar_edicao = customtkinter.CTkButton(quadro_edicao, text="Enviar", text_color="black", fg_color="#83A2EB", width=100, corner_radius= 30)
botao_enviar_edicao.grid(row=5, column=3, columnspan=1, pady=5, padx=5, sticky="w")
 
botao_remover_edicao = customtkinter.CTkButton(quadro_edicao, text="Remover", text_color="black", fg_color="#83A2EB", width=100, corner_radius= 30)
...
pesquisar_saida.grid(row=1, column=0, rowspan=3, padx=5, sticky="n")
